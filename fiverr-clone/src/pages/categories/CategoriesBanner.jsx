    ...
    return (
        <div className='categories-banner mt-40'>
            ...
            <div className="categories-banner-wrapper container rounded-lg bg-contain bg-center bg-no-repeat" style={{ backgroundImage: `url('https://fiverr-res.cloudinary.com/image/upload/f_auto,q_auto/v1/attachments/generic_asset/asset/3f1b7ea10295936b6846bcff0afd38cf-1626595415207/digital-marketing-desktop.png')`, height: '300px' }}>
                <div className="categories-banner ">
                    <div className="banner-content text-center text-white">
                        ...
                        <div className="px-20">
                            <button className='hover:bg-white hover:text-pink-400 font-medium' onClick={() => {
                                setVideoCate(videocate + 1)
                                setVideoClose(close + 1)
                            }}>
                                <p aria-hidden="true" style={{ width: 19, height: 16 }}>
                                    <svg width={18} height={18} viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg" fill="currentFill">
            ...
            <div className='video-close'>
                <video id='myVideo' className="orca-video" style={{ display: `${videocate % 2 === 0 ? 'block' : 'none'}` }} controls poster preload="metadata" crossOrigin="anonymous"><source src="https://fiverr-res.cloudinary.com/video/upload/t_fiverr_hd_nl/v1/video-attachments/generic_asset/asset/ab0907217c9f9a2c1d2eee677beb7619-1626082923646/how_fiverr_works" type="video/mp4" /></video>
                <span className='bg-pink-400 rounded-sm close text-white' onClick={() => {
                    pauseVid()
                    setVideoCate(videocate + 1);
                    setVideoClose(close + 1)
                }} style={{ display: `${close % 2 !== 0 ? 'none' : 'block'}` }}>  <CloseOutlined /></span>
            </div>
